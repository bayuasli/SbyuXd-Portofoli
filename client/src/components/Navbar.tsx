...
export function Navbar() {
  ...
  const socialLinks = [
    { label: "GitHub", icon: Github, href: "https://github.com/bayuasli", color: "text-gray-600 dark:text-gray-400" },
    { label: "YouTube", icon: Youtube, href: "https://www.youtube.com/@BayuCrasher", color: "text-red-500" },
    { label: "WhatsApp", icon: MessageCircle, href: "https://wa.me/628895307489", color: "text-green-500" },
    { label: "Telegram", icon: Send, href: "https://t.me/bayuror", color: "text-blue-500" },
    { label: "Email", icon: Mail, href: "bayuror24@gmail.com", color: "text-purple-500" },
  ];
